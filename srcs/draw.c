...
static void	get_texture(t_game *game, mlx_texture_t *wall)
{
	...
	game->tex_pos = ((double)game->draw_start - (double)MAX_H / 2
			+ (double)game->line_height / 2) * game->incr;
}
